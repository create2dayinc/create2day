...
BLOG_AUTHOR = "Create 2 Day Inc."  # (translatable)
...
BLOG_EMAIL = "create2dayinc@gmail.com"
BLOG_DESCRIPTION = "Website for Create2Day, a nonprofit organization."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/","Home"),
        ((("/stories/about#who-we-are","Who We Are"),("/stories/about#mission","Mission Statement"),("/stories/about/#three-rs","Three R's"),
            ), "About"),
        ("/stories/visit/","Visit"),
        ("/stories/contact/","Contact"),
        #("/archive.html", "Archive"), unnecessary
        #("/categories/", "Tags"),
        ((("/stories/programs#birthdays", "Birthday Parties"), ("/stories/programs#birthday-in-a-box", "Birthday in a Box"), ("/stories/programs#gifts-for-seniors", "Gifts for Seniors")), "Programs"),
        ((("/stories/events#calendar", "Calendar"),("/stories/events#events", "Events"),("/stories/events#sewing", "Sewing")), "Events"),
        ("/galleries", "Photos"),
        #("/blog/", "Blog"), not today
        #("/rss.xml", "RSS"),
    ),
